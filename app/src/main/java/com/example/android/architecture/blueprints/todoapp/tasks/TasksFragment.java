...
public class TasksFragment extends Fragment {
    ...
    public static class TasksAdapter extends BaseAdapter {
        ...
        TasksAdapter(List<Task> tasks, @Nullable TasksActivity taskItemNavigator,
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            final TaskItemViewModel viewmodel = new TaskItemViewModel(viewGroup.getContext().getApplicationContext(), mTasksRepository);
